      ...
      <div className="flex items-center justify-between gap-4 border-b border-slate-200/80 pb-4">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-2xl text-xs sm:text-sm font-bold transition-all relative cursor-pointer ${
        ...
        {activeMainTab === 'calendar' && (
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 text-xs font-bold transition-all shadow-xs cursor-pointer"
          >
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/booking"
                className="text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 py-2.5 px-4 rounded-xl flex items-center gap-1.5 shadow-xs transition-transform hover:scale-105 active:scale-95"
              >
          ...
          <div className="flex items-center gap-2 mb-5 bg-white p-1.5 rounded-2xl border border-slate-200/80 w-fit shadow-xs">
            <button
            ...
            >
              ...
              <span>יומן אינטראקטיבי מתקדם</span>
            </button>
          </div>
