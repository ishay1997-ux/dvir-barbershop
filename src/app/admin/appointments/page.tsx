          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-2xl text-xs sm:text-sm font-bold transition-all cursor-pointer ${
              activeMainTab === 'calendar'
                ...
                : 'bg-[#111420] text-slate-400 border border-slate-800/80 hover:border-slate-700 hover:text-white'
            }`}
          >
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/booking"
                className="text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 py-2.5 px-4 rounded-xl flex items-center gap-1.5 shadow-md shadow-indigo-600/30 transition-transform hover:scale-105 active:scale-95"
              >
          ...
          <div className="flex items-center gap-2 mb-5 bg-[#111420] p-1.5 rounded-2xl border border-slate-800/80 w-fit shadow-md">
            <button
