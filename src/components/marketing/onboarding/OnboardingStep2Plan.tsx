...
const industriesList = [
  { id: 'מספרות ועיצוב שיער גברים', label: 'מספרות גברים', icon: '💈' },
  { id: 'קוסמטיקה, ציפורניים & טיפוח', label: 'קוסמטיקה & ציפורניים', icon: '💅' },
  { id: 'ספא, טיפולי גוף ומסאז׳', label: 'ספא & טיפולי גוף', icon: '🌿' },
  { id: 'אימונים אישיים & כושר', label: 'כושר & אימונים', icon: '🏋️' },
  { id: 'קליניקות אסתטיקה & רופאים', label: 'קליניקה אסתטית', icon: '🩺' },
