...
const THEME_PRESETS = [
  {
    id: 'dark-obsidian',
    name: 'Dark Obsidian (שחור פחם יוקרתי)',
  ...
  {
    id: 'brand-midnight',
    name: 'Brand Midnight (כחול לילה עמוק)',
    description: 'גווני נייבי-מידנייט עשירים ומרשימים המשדרים עוצמה, דיוק ואיכות פרימיום.',
    bg: '#080c10',
  ...
  {
    id: 'luxury-light',
    name: 'Luxury Light (שיש לבן וזהב)',
    description: 'עיצוב בהיר, נקי, יוקרתי ואוורירי עם ניגודיות מעולה ורקע שיש מודרני.',
    bg: '#F8FAFC',
    accentPreview: '#C9A84C',
    isDark: false,
  },
  {
    id: 'cyber-carbon',
    name: 'Cyber Carbon (קרבון מודרני וחד)',
    description: 'שחור קרבון טכנולוגי עם קווי מתאר חדים וזוהר מודרני.',
    bg: '#09090B',
...
const COLOR_PALETTES = [
  { name: 'זהב פרימיום (Royal Gold)', hex: '#C9A84C' },
  { name: 'ענבר יוקרתי (Amber Warm)', hex: '#D97706' },
  { name: 'אמרלד פרימיום (Emerald Green)', hex: '#10B981' },
  { name: 'קובלט אלגנטי (Cobalt Blue)', hex: '#2563EB' },
  { name: 'רובי נועז (Ruby Rose)', hex: '#E11D48' },
  { name: 'פלטינום וסילבר (Platinum Slate)', hex: '#94A3B8' },
  { name: 'ברונזה קלאסי (Classic Bronze)', hex: '#B45309' },
];
